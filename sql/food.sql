...
INSERT INTO `orders` (`id`, `customer_id`, `date`, `payment_type`, `total`, `status`, `deleted`) VALUES
(1, 2, '2017-03-28 17:32:41', 'Wallet', 150, 'Yet to be delivered', 0),
(2, 2, '2017-03-28 17:43:05', 'Wallet', 130, 'Cancelled by Customer', 1),
(3, 3, '2017-03-28 19:49:33', 'Cash On Delivery', 130, 'Yet to be delivered', 0),
...
(2, 'Customer', 'Customer 1', 'user1', 'pass1', 'mail2@example.com', 9898000001, 1, 0),
(3, 'Customer', 'Customer 2', 'user2', 'pass2', 'mail3@example.com', 9898000002, 1, 0),
